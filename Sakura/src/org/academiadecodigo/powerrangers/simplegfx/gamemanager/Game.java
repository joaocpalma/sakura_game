...
public class Game {
    ...
    public void start() {
        ...
        hero = new Hero(200,340,"media/Chars/Carlos/Char_Carlos_Front_Feet_Together.png");
        //Mc= new Mcs("Sakura/media/Moobs/Tsuru_-_Up_Wing_Left.png");
        //Mc1= new Mcs("Sakura/media/Moobs/Tsuru_-_Up_Wing_Left.png");

        flower = new Flower(400,640,"Sakura/media/Flower/flower.png");
    ...
    public void start7() {
        ...
        lvl = new Picture(0, 0, "Sakura/media/Level/Game Background level 7.jpg");
        lvl.draw();
    ...
    public void start8() {
        ...
        lvl = new Picture(0, 0, "Sakura/media/Level/Game Background level 8.jpg");
        lvl.draw();
        //grid = new Grid(17,9);
