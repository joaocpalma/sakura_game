...
public class Hero {
    ...
    public Picture hero;
    int count = 0;
    private String nextPicture = Game.prefix + "Char_Carlos_Front_Feet_Together.png";
    ...
    public void moveRight() {
        if(direction){
            nextPicture = Game.prefix + "Char_Carlos_Front_Feet_Together.png";
    ...
    public void moveLeft() {
        if(!direction){
            nextPicture = Game.prefix + "Char_Carlos_Back_Normal.png";
            hero.load(nextPicture);
        }
        direction = true;
        hero.translate(-10, 0);
    ...
    public void checkNextPicture(int key) {
        if (key == KeyboardEvent.KEY_D) {
            if (nextPicture.equals(Game.prefix + "Char_Carlos_Front_Feet_Together.png")) {
                nextPicture = Game.prefix + "Char_Carlos _Front_Normal.png";
            } else {
                nextPicture = Game.prefix + "Char_Carlos_Front_Feet_Together.png";
            }
        }
        if (key == KeyboardEvent.KEY_A) {
            if (nextPicture.equals(Game.prefix + "Char_Carlos_Back_Feet_Together.png")) {
                nextPicture = Game.prefix + "Char_Carlos_Back_Normal.png";
            } else {
                nextPicture = Game.prefix + "Char_Carlos_Back_Feet_Together.png";
            }
        }
    }
